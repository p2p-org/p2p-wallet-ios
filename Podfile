...
target 'p2p_wallet' do
  ...
  pod 'BECollectionView_Core', :git => 'https://github.com/bigearsenal/BECollectionView.git', :branch => 'feature/swift_concurrency_stream'
  pod 'BECollectionView', :git => 'https://github.com/bigearsenal/BECollectionView.git', :branch => 'feature/swift_concurrency_stream'
  pod 'BECollectionView_Combine', :git => 'https://github.com/bigearsenal/BECollectionView.git', :branch => 'feature/swift_concurrency_stream'
