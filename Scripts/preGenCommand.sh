...
[ ! -f src ] || rm -rf p2p_wallet/Base.lproj-backup
[ ! -f src ] || rm -rf p2p_wallet/en.lproj-backup
[ ! -f src ] || rm -rf p2p_wallet/ru.lproj-backup
[ ! -f src ] || rm -rf p2p_wallet/fr.lproj-backup
[ ! -f src ] || rm -rf p2p_wallet/vi.lproj-backup
