...
public class DefaultSwapFeeRelayerCalculator: SwapFeeRelayerCalculator {
    ...
    public func calculateSwappingNetworkFees(
        ...
        // when destination is not native SOL and needs to be created
            ...
            switch result {
            case let .splAccount(needsCreation) where needsCreation:
        ...
        // CHECK OTHER
        // in transitive swap, there will be situation when swapping from SOL -> SPL that needs spliting transaction to
        // 2 transactions
