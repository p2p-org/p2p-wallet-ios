...
class APIClientParamsTests: XCTestCase {
    ...
    func testEncodingRelayTransactionParams() async throws {
        let phrase =
            "assume legend squirrel drastic immense ribbon reduce thrive page uncover vehicle cart right tank wheel whisper ride pet wall august link wheel moment enlist"
