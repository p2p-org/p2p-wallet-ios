...
final class RelayContextManagerTests: XCTestCase {
    ...
    override func setUp() async throws {
        ...
        contextManager = try RelayContextManagerImpl(
...
private class MockSolanaAPIClient: MockSolanaAPIClientBase {
    override func getMinimumBalanceForRentExemption(dataLength: UInt64,
                                                    commitment _: Commitment?) async throws -> UInt64
    {
        switch dataLength {
        case 165:
            return 2_039_280
    ...
    override func getFees(commitment _: Commitment?) async throws -> Fee {
        .init(
