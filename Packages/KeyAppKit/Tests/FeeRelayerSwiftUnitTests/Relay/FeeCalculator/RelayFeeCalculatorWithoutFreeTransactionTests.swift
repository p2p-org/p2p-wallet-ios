...
class RelayFeeCalculatorWithoutFreeTransactionTests: XCTestCase {
    ...
    func testWhenUserTotallyHasNoFreeTransactionLeft() async throws {
        ...
        let amountCovered = currentRelayAccountBalance - minimumRelayAccountBalance - expectedTxFee
            .transaction - topUpFee
        ...
        currentRelayAccountBalance = minimumRelayAccountBalance + expectedTxFee.transaction + topUpFee + expectedTxFee
            .accountBalances
    ...
    private func getContext(
        ...
        RelayContext(
            ...
            usageStatus: .init(
                ...
                amountUsed: 10_000_000 - freeAmountLeft,
