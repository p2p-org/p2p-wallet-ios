...
class CryptoTests: XCTestCase {
    ...
    //     let seed =
    //         "slice sauce assist glimpse jelly trouble parent horror bread isolate uncle gallery owner angry rose
    //         fabric stable phrase much joke cotton mesh ancient erase"
    //     let result = try WalletMetaData.decrypt(seedPhrase: seed, data: m)
    //     print(result)
    // }
    //
    // func testA() async throws {
    //     let seedPhrase = "slice sauce assist glimpse jelly trouble parent horror bread isolate uncle gallery owner
    //     angry rose fabric stable phrase much joke cotton mesh ancient erase"
