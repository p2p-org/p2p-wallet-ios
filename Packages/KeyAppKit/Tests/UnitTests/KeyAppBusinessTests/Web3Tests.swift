...
final class EthereumTests: XCTestCase {
    ...
    func testGetBalance() throws {
        ...
        try web3.eth.getBalance(
            address: .init(hex: "0x0583B332697C1406E8fa82deBF224B285Dc25632", eip55: true),
            block: .latest
        ) { response in
            print(response)
            expectation.fulfill()
    ...
    func testGetERC20Tokens() throws {
        ...
        try contract.balanceOf(address: EthereumAddress(hex: "0x96b1BE95ca5ec06d9bd6926e1c5302E1265049C0", eip55: true))
