...
final class BundleCodingTests: XCTestCase {
    ...
    func testDecodeBundle2() throws {
        let json = """
            {"bundle_id":"9341f85c-c0b3-41ef-a888-9b2e00c447f4","user_wallet":"0xc77b22884e476ddf4c60fadc7605e74bddaba426","recipient":"3f1jB3pieiLw1XstjrAG5pRC1xGaF3XTpjmhNMMmyGJA","token":"0xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48","with_compensations":"yes","expires_at":"2023-03-01T16:40:54.079434Z","transactions":["0xf867108506fc23ac0083011b2094a0b86991c6218b36c1d19d4a2e9eb0ce3606eb4880b844095ea7b30000000000000000000000003ee18b2214aff97000d974cf647e7c347e8fa58500000000000000000000000000000000000000000000000000000000000f4240",""],"signatures":null,"fees":{"gas":{"amount":"11131798148183700","usd_amount":"16.6976131"},"arbiter":{"amount":"2000000","usd_amount":"2"},"create_account":{"amount":"41438","usd_amount":"0.0414381696"}}}
        """
        guard let data = json.data(using: .utf8) else {
            XCTExpectFailure("Preparing data error")
            return
