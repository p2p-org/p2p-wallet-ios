...
class SendViaLinkDataServiceImplTests: XCTestCase {
    ...
    func testGetClaimableSOLTokenInfo_WithInValidLastTransaction_ButValidAccountBalance_ShouldReturnSuccess(
    ) async throws {
    ...
    func testGetClaimableSPLTokenInfo_WithInValidLastTransaction_ButValidAccountBalance_ShouldReturnSuccess(
    ) async throws {
        solanaAPIClient.getSignaturesForAddressResponse = "" // invalid
        solanaAPIClient.getTransactionResponse = "" // invalid
