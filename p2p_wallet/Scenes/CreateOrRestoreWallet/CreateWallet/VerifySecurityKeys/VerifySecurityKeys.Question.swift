...
extension VerifySecurityKeys {
    ...
    private class Cell: UITableViewCell {
        ...
        private let title: UILabel = UILabel(textColor: .h8e8e93)
        private let questionsRow: UIStackView = UIStackView(axis: .horizontal, spacing: 8, alignment: .fill, distribution: .fillEqually)
        weak var delegate: QuestionsDelegate?
