...
protocol NewRestoreWalletViewModelType: ReserveNameHandler, AccountRestorationHandler {
...
extension NewRestoreWallet.ViewModel: NewRestoreWalletViewModelType {
...
extension NewRestoreWallet.ViewModel {
...
extension NewRestoreWallet.ViewModel: ReserveNameHandler {
    @MainActor
...
private extension NewRestoreWallet.ViewModel {
    @MainActor
    func finish() {
