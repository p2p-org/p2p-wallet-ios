        ...
        func driven(with driver: Driver<ParsedTransaction?>) -> TransactionDetail.NavigationBar {
            driver
                .map { parsedTransaction -> String in
                    ...
                    case let swapTransaction as SwapTransaction:
