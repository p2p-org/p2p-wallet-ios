...
final class SettingsViewModel: ObservableObject {
    ...
    var appInfo: String {
        "\(L10n.appVersion): \(appVersion)\(Environment.current != .release ? ("(" + Bundle.main.buildVersionNumber + ")" + " " + Environment.current.description) : "")"
    }
    ...
    func updateNameIfNeeded() {
        name = storageName != nil ? storageName!.withNameServiceDomain() : L10n.notYetReserved
    }
}
