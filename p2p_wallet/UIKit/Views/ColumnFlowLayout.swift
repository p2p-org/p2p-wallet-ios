...
class ColumnFlowLayout: UICollectionViewFlowLayout {
    ...
    override func prepare() {
        ...
        let marginsAndInsets = sectionInset.left + sectionInset.right + collectionView.safeAreaInsets
            .left + collectionView.safeAreaInsets.right + minimumInteritemSpacing * CGFloat(cellsPerRow - 1)
