...
///
open class CoordinatorAnimation: NSObject {
    ...
    ///
    public static let `default` = CoordinatorAnimation(presentation: nil, dismissal: nil)
...
extension CoordinatorAnimation: UIViewControllerTransitioningDelegate {
